...
public class GuiIceCreamMaker extends GuiContainer {
	...
	private static final ResourceLocation ICE_CREAM_MAKER_TEXTURES = new ResourceLocation(Reference.MOD_ID + ":" + "textures/gui/container/icecreammaker.png");
	...
	public GuiIceCreamMaker(InventoryPlayer player, TileEntityIceCreamMaker tileentity) {
		super(new ContainerIceCreamMaker(player, tileentity));
		this.player = player;
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		this.mc.getTextureManager().bindTexture(ICE_CREAM_MAKER_TEXTURES);

		this.drawTexturedModalRect(this.guiLeft, this.guiTop, 0, 0, this.xSize, this.ySize);

		

		if(TileEntityIceCreamMaker.isBurning(this.tileentity)) {
