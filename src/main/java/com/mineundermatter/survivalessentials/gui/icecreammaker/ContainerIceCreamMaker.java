package com.mineundermatter.survivalessentials.gui.icecreammaker;

import com.mineundermatter.survivalessentials.recipe.IceCreamRecipes;
import com.mineundermatter.survivalessentials.slot.SlotIceCreamMakerFuel;
import com.mineundermatter.survivalessentials.slot.SlotIceCreamMakerOutput;
...
public class ContainerIceCreamMaker extends Container {
	...
	private final TileEntityIceCreamMaker tileentity;
	...
	public ContainerIceCreamMaker(InventoryPlayer player, TileEntityIceCreamMaker tileentity) {
		this.tileentity = tileentity;
		this.addSlotToContainer(new Slot(tileentity, 0, 20, 18));
		this.addSlotToContainer(new Slot(tileentity, 1, 140, 18));
		this.addSlotToContainer(new SlotIceCreamMakerFuel(tileentity, 2, 80, 59));
		this.addSlotToContainer(new SlotIceCreamMakerOutput(player.player, tileentity, 3, 80, 19));
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
		...
		if(slot != null && slot.getHasStack()) {
			...
			if(index == 3) {
				...
				if(!IceCreamRecipes.instance().getIceCreamingResult(stack1, slot1.getStack()).isEmpty())

					if(!this.mergeItemStack(stack1, 0, 2, false))

						return ItemStack.EMPTY;

				else if(TileEntityIceCreamMaker.isItemFuel(stack1))
