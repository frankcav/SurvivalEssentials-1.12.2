...
public class TileEntityIceCreamMaker extends TileEntity implements IInventory, ITickable {
	...
	public String getName() {
		...
		return this.hasCustomName() ? this.customName : "container.ice_cream_maker";
	}
	...
	public void update() {
		...
		if(!this.world.isRemote) {
			...
			if(flag != this.isBurning()) {
				...
				BlockIceCreamMaker.setState(this.isBurning(), this.world, this.pos);
	...
	private boolean canSmelt() {
		...
		if(((ItemStack)this.inventory.get(0)).isEmpty() || ((ItemStack)this.inventory.get(1)).isEmpty())
			...
			ItemStack result = IceCreamRecipes.instance().getIceCreamingResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));
...
public void smeltItem() {
	...
	if(this.canSmelt()) {
		...
		ItemStack result = IceCreamRecipes.instance().getIceCreamingResult(input1, input2);
...
public static int getItemBurnTime(ItemStack fuel) {
	...
	if(fuel.isEmpty())
		...
		if (item ==EssentialItems.crushed_ice) return 400;
...
public String getGuiID() {
	...
	return "survivalessentials:icecreammaker";
