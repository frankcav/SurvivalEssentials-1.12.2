...
public class TileEntityWaffleMaker extends TileEntity implements IInventory, ITickable {
	...
	public String getName() {
		...
		return this.hasCustomName() ? this.customName : "container.waffle_maker";
	}
	...
	public void update() {
		...
		if(!this.world.isRemote) {
			...
			if(flag != this.isBurning()) {
				...
				BlockWaffleMaker.setState(this.isBurning(), this.world, this.pos);
	...
	private boolean canSmelt() {
		...
		if(((ItemStack)this.inventory.get(0)).isEmpty() || ((ItemStack)this.inventory.get(1)).isEmpty())
			...
			ItemStack result = WaffleRecipes.instance().getWaffleMakingResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));
...
public void smeltItem() {
	...
	if(this.canSmelt()) {
		...
		ItemStack result = WaffleRecipes.instance().getWaffleMakingResult(input1, input2);
...
public String getGuiID() {
	...
	return "survivalessentials:wafflemaker";
