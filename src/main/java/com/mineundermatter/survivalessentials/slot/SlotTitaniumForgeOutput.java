...
public class SlotTitaniumForgeOutput extends Slot {
	...
	public SlotTitaniumForgeOutput(EntityPlayer player, IInventory inventoryIn, int index, int xPosition, int yPosition) {
	...
	protected void onCrafting(ItemStack stack) {
		...
		if(!this.player.world.isRemote) {
			...
			float f = TitaniumForgeRecipes.instance().getSmeltingExperience(stack);
