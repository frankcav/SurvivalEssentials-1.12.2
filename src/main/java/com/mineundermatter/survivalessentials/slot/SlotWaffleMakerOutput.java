...
public class SlotWaffleMakerOutput extends Slot {
	...
	public SlotWaffleMakerOutput(EntityPlayer player, IInventory inventoryIn, int index, int xPosition, int yPosition) {
	...
	protected void onCrafting(ItemStack stack) {
		...
		if(!this.player.world.isRemote) {
			...
			float f = WaffleRecipes.instance().getWaffleMakingExperience(stack);
