...
public class SlotIceCreamMakerOutput extends Slot {
	...
	public SlotIceCreamMakerOutput(EntityPlayer player, IInventory inventoryIn, int index, int xPosition, int yPosition) {
	...
	protected void onCrafting(ItemStack stack) {
		...
		if(!this.player.world.isRemote) {
			...
			float f = IceCreamRecipes.instance().getIceCreamingExperience(stack);
