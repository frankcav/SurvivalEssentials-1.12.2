...
public class BlockRadioactiveRedstoneWire extends Block {

	public static final PropertyEnum<BlockRadioactiveRedstoneWire.EnumAttachPosition> NORTH = PropertyEnum.<BlockRadioactiveRedstoneWire.EnumAttachPosition>create("north", BlockRadioactiveRedstoneWire.EnumAttachPosition.class);
    public static final PropertyEnum<BlockRadioactiveRedstoneWire.EnumAttachPosition> EAST = PropertyEnum.<BlockRadioactiveRedstoneWire.EnumAttachPosition>create("east", BlockRadioactiveRedstoneWire.EnumAttachPosition.class);
    public static final PropertyEnum<BlockRadioactiveRedstoneWire.EnumAttachPosition> SOUTH = PropertyEnum.<BlockRadioactiveRedstoneWire.EnumAttachPosition>create("south", BlockRadioactiveRedstoneWire.EnumAttachPosition.class);
    public static final PropertyEnum<BlockRadioactiveRedstoneWire.EnumAttachPosition> WEST = PropertyEnum.<BlockRadioactiveRedstoneWire.EnumAttachPosition>create("west", BlockRadioactiveRedstoneWire.EnumAttachPosition.class);
    ...
    public BlockRadioactiveRedstoneWire()
    {
        super(Material.CIRCUITS);
        this.setDefaultState(this.blockState.getBaseState().withProperty(NORTH, BlockRadioactiveRedstoneWire.EnumAttachPosition.NONE).withProperty(EAST, BlockRadioactiveRedstoneWire.EnumAttachPosition.NONE).withProperty(SOUTH, BlockRadioactiveRedstoneWire.EnumAttachPosition.NONE).withProperty(WEST, BlockRadioactiveRedstoneWire.EnumAttachPosition.NONE).withProperty(POWER, Integer.valueOf(0)));
    ...
    {
        int i = 0;
        boolean flag = state.getValue(NORTH) != BlockRadioactiveRedstoneWire.EnumAttachPosition.NONE;
        boolean flag1 = state.getValue(EAST) != BlockRadioactiveRedstoneWire.EnumAttachPosition.NONE;
        boolean flag2 = state.getValue(SOUTH) != BlockRadioactiveRedstoneWire.EnumAttachPosition.NONE;
        boolean flag3 = state.getValue(WEST) != BlockRadioactiveRedstoneWire.EnumAttachPosition.NONE;
    ...
    private BlockRadioactiveRedstoneWire.EnumAttachPosition getAttachPosition(IBlockAccess worldIn, BlockPos pos, EnumFacing direction)
    {
        ...
        if (!canConnectTo(worldIn.getBlockState(blockpos), direction, worldIn, blockpos) && (iblockstate.isNormalCube() || !canConnectUpwardsTo(worldIn, blockpos.down())))
        {
            ...
            if (!iblockstate1.isNormalCube())
            {
                ...
                if (flag && canConnectUpwardsTo(worldIn, blockpos.up()))
                {
                    ...
                    {
                        return BlockRadioactiveRedstoneWire.EnumAttachPosition.UP;
                    }

                    return BlockRadioactiveRedstoneWire.EnumAttachPosition.SIDE;
                }
            }

            return BlockRadioactiveRedstoneWire.EnumAttachPosition.NONE;
        }
        else
        {
            return BlockRadioactiveRedstoneWire.EnumAttachPosition.SIDE;
    ...
    {
        return EssentialItems.radioactive_redstone_dust;
    }
    ...
    protected static boolean canConnectTo(IBlockState blockState, @Nullable EnumFacing side, IBlockAccess world, BlockPos pos)
    {
        ...
        if (block == EssentialBlocks.radioactive_redstone_wire)
        {
            return true;
        }
    ...
    {
        return new ItemStack(EssentialItems.radioactive_redstone_dust);
    }
