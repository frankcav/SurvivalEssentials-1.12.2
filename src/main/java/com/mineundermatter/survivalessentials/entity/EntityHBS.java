...
public class EntityHBS extends EntityArrow {
...
//added by me\\
    ...
    public EntityHBS(World worldIn) {

        super(worldIn);

        this.pickupStatus = EntityHBS.PickupStatus.DISALLOWED;
...
//
    ...
    public EntityHBS(World worldIn, EntityLivingBase shooter) {
    ...
    public EntityHBS(World worldIn, double x, double y, double z) {
...

    	    {
...

    	        {
...

    	            {
    	                ...
    	                this.playSound(SoundEvents.ENTITY_ENDERMEN_DEATH,  1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
...

    	            {
...

    	                {
    	                    ...
    	                    if (this.pickupStatus == EntityHBS.PickupStatus.ALLOWED)
    	        ...
    	        {	
    	            ...
    	            this.playSound(SoundEvents.BLOCK_METAL_HIT, 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
    ...
    public ItemStack getArrowStack() {
        ...
        return new ItemStack(EssentialItems.bullet_casing);//what you pick up after the arrow is shot
    ...
    public void arrowHit(EntityLivingBase living) {
        ...
        this.playSound(SoundEvents.BLOCK_GLASS_BREAK,  1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));//sound
