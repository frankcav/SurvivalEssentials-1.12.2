...
public class EntityMBS extends EntityArrow {
...
//added by me\\
    ...
    public EntityMBS(World worldIn) {

        super(worldIn);

        this.pickupStatus = EntityMBS.PickupStatus.DISALLOWED;
...
//
    ...
    public EntityMBS(World worldIn, EntityLivingBase shooter) {
    ...
    public EntityMBS(World worldIn, double x, double y, double z) {
...

    	        {
...

    	            {
...

    	                {
    	                    ...
    	                    if (this.pickupStatus == EntityMBS.PickupStatus.ALLOWED)
